...
typedef bool(__fastcall* ScriptCallback)(Script*, void*);
...
class ScriptEngine {
 ...
 public:
  ...
  Script* NewScript(const char* file, ScriptMode mode, bool recompile = false);
  ...
  bool ForEachScript(ScriptCallback callback, void* argv);
