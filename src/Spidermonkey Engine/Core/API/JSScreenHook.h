...
static JSPropertySpec frame_props[] = {{"x", FRAME_X, JSPROP_STATIC_VAR, JSOP_WRAPPER(frame_getProperty), JSOP_WRAPPER(frame_setProperty)},
...
static JSPropertySpec box_props[] = {{"x", BOX_X, JSPROP_STATIC_VAR, JSOP_WRAPPER(box_getProperty), JSOP_WRAPPER(box_setProperty)},
...
static JSPropertySpec line_props[] = {{"x", LINE_X, JSPROP_STATIC_VAR, JSOP_WRAPPER(line_getProperty), JSOP_WRAPPER(line_setProperty)},
...
static JSPropertySpec text_props[] = {{"x", TEXT_X, JSPROP_STATIC_VAR, JSOP_WRAPPER(text_getProperty), JSOP_WRAPPER(text_setProperty)},
...
static JSPropertySpec image_props[] = {{"x", IMAGE_X, JSPROP_STATIC_VAR, JSOP_WRAPPER(image_getProperty), JSOP_WRAPPER(image_setProperty)},
