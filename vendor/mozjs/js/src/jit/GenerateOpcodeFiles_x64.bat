...
py -c "from GenerateOpcodeFiles import *;f=open(\"LOpcodesGenerated.h\", \"w\");generate_lir_header(f, \"LIR.h\", \"shared/LIR-shared.h\", \"x86-shared/LIR-x86-shared.h\", \"x64/LIR-x64.h\");"
